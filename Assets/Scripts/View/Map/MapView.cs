...
public class MapView : MonoBehaviour
{
    ...
    public Vector2 center0; // centerBase
    ...
    private IEnumerator InitializeLocation()
    {
        ...
        {
            Debug.Log("Íåâîçìîæíî îïðåäåëèòü ìåñòîïîëîæåíèå.");
            center = new GeoLocation(56.468733f, 84.945077f); //56.45245f, 84.97238f - 7 îáùåæèòèå
            yield break;
        }
        else if (Input.location.status == LocationServiceStatus.Stopped || timeout <= 0)
        {
            Debug.LogWarning("GPS íåäîñòóïåí");
            center = new GeoLocation(56.468733f, 84.945077f); //56.45245f, 84.97238f - 7 îáùåæèòèå
        }
        else
        {
